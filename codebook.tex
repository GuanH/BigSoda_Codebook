...
\section{幾何}
\subsection{宣告}
\lstinputlisting{geometry/declarations.cpp}
\subsection{矩形面積}
...
\subsection{樹哈希}
\lstinputlisting{graph/tree_hash.cpp}
\subsection{差分約束}
...
\lstinputlisting{other/hilbert_curve.cpp}
\subsection{模擬退火}
